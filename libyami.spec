...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644257544
...
cp %{_builddir}/libyami-1.3.2/LICENSE.md %{buildroot}/usr/share/package-licenses/libyami/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/libyami-1.3.2/codecparsers/dboolhuff.LICENSE %{buildroot}/usr/share/package-licenses/libyami/4dbe7c1f3a1833a88333a7c282119323e9ef44fa
cp %{_builddir}/libyami-1.3.2/codecparsers/vp9quant.LICENSE %{buildroot}/usr/share/package-licenses/libyami/e9e216e41252f23ea09d1377ed8b9061db7db903
cp %{_builddir}/libyami-1.3.2/gtestsrc/gtest/LICENSE %{buildroot}/usr/share/package-licenses/libyami/5a2314153eadadc69258a9429104cd11804ea304
%make_install
